...
class Login_User():
    ...
    def __init__(self, **kwargs):
        ...
        try:
            ...
            self.db = pymysql.connect(host="mysql-31822-0.cloudclusters.net" ,user="ThembekileNalla", password="Th3mb3k!l3#5",database="CafeNalla", port=31822)
    ...
    def update_user_password(self, **kwargs):
        ...
        update_password = f"""UPDATE {self.user_table} SET Password = '{new_password}'
                            WHERE id = {user_id};
                            """
        try:
            # Execute SQL command
